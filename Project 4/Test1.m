...
%Read the MIL data
positions_MIL = csvread(strcat(base_path,'tiger1/tiger1_MIL_TR001.txt'));
...
for frame = 1:numel(img_files)
	...
	if frame > 1
        ...
        if PSR > 5.5
            ...
            %For Tiger1
            %get the prediction by past measurements
            pos_My = predict(kalmanFilter);
            %correct the measurement with previous measurements
            pos_My = correct(kalmanFilter, pos_My);
...
csvwrite('Tiger1_Kalman_output.txt', positions_output);
